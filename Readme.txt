...
OKLM est une application qui permet aux etudiants et aux publics de faire des reservations de places cinema universitaire
l'acces y est possible avec ou sans matricule .Pour le moment, on est qu'a linscriptions,l'affiiche des listes de reservations dans la 
bd et l'affiichedu programme de films non reactive.
...
Pour l'installation merci de suivre les étapes suivantes:
    ...
    -Telecharger dans votre eclipse windows Builder.
	************************************
*****  		Version du jdk utilisé		  	*****
	************************************
java version "1.8.0_144"
Java(TM) SE Runtime Environment (build 1.8.0_144-b02)
...
1) 	A l'aide de votre interpretteur de commande (cmd.exe),
	...
	le fichier compressé "OKLM.jar"
	('cd [chemin]/[dossier cible]').

2)	Entrer la commande 'java -jar Espacedetente.jar'.

3)Ouvrir eclipse,importer le projet .

4)Passer en mode DESIGN.

5)Base de données Xamp server a importer.
